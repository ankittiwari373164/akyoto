    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-950 via-primary-900 to-dark-800 flex items-center justify-center py-12 px-4 relative overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-3 mb-5">
            ...
            <div className="text-left">
              <span className="text-2xl font-extrabold text-white tracking-tight" style={{fontFamily:'Manrope,sans-serif'}}>AKYOTO</span>
        ...
        <div className="flex bg-primary-900/60 border border-primary-700/40 rounded-xl p-1 mb-6 backdrop-blur-sm">
          <button onClick={() => setIsLogin(true)} className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${isLogin ? 'bg-white text-primary-900 shadow-sm' : 'text-primary-300 hover:text-white'}`} style={{fontFamily:'Manrope,sans-serif'}}>
            Login
          </button>
          <button onClick={() => setIsLogin(false)} className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${!isLogin ? 'bg-white text-primary-900 shadow-sm' : 'text-primary-300 hover:text-white'}`} style={{fontFamily:'Manrope,sans-serif'}}>
            Register
          </button>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-400 hover:to-primary-500 text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-primary-900/50 flex items-center justify-center gap-2 disabled:opacity-50 mt-2" style={{fontFamily:'Manrope,sans-serif'}}>
