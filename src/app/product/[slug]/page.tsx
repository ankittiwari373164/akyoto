...
export default function ProductDetailPage() {
  ...
  const [activeTab, setActiveTab] = useState<'description' | 'details' | 'specs' | 'installation'>('description')
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold mb-4" style={{fontFamily:'Manrope,sans-serif'}}>Product not found</h2>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
                ...
                <h1 className="text-3xl font-extrabold text-slate-900 mt-3 mb-3 leading-tight" style={{fontFamily:'Manrope,sans-serif'}}>{product.name}</h1>
                ...
                <div className="flex items-baseline gap-3 mb-5">
                  <span className="text-4xl font-extrabold text-primary-700" style={{fontFamily:'Manrope,sans-serif'}}>
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-2xl font-bold w-12 text-center" style={{fontFamily:'Manrope,sans-serif'}}>{quantity}</span>
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
            <div className="flex border-b border-slate-100">
              {(['description', 'details', 'specs', 'installation'] as const).map(tab => (
                <button key={tab} onClick={() => setActiveTab(tab)}
                  ...
                  {tab === 'description' ? 'Description' : tab === 'details' ? 'Product Details' : tab === 'specs' ? 'Specifications' : 'Installation'}
                </button>
              ))}
            </div>
            <div className="p-8">
              {activeTab === 'description' && (
                <p className="text-slate-600 leading-relaxed whitespace-pre-line">{product.description || 'No description available for this product yet.'}</p>
              )}
              {activeTab === 'details' && (
