...
const categories = [
  ...
  { value: 'Security Alarm System',        label: 'Security Alarm System' },
  { value: 'Gas Alarm',                    label: 'Gas Alarm' },
  { value: 'Carbon Monoxide Alarm',        label: 'Carbon Monoxide Alarm' },
  { value: 'Smoke Alarm',                  label: 'Smoke Alarm' },
  { value: 'Composite Alarm',              label: 'Composite Alarm' },
  { value: 'Audible and Visual Alarm',     label: 'Audible & Visual Alarm' },
  { value: 'Wireless Intelligent Doorbell', label: 'Wireless Intelligent Doorbell' },
  { value: 'Door Magnet Sensor',           label: 'Door Magnet Sensor' },
  { value: 'Intelligent Single Product',   label: 'Intelligent Single Product' },
]
      ...
      <section className="bg-gradient-to-br from-primary-900 to-primary-800 py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
            <h1 className="text-5xl font-extrabold text-white mb-4" style={{fontFamily:'Manrope,sans-serif'}}>Security Products</h1>
          ...
          <aside className={`lg:w-64 flex-shrink-0 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 sticky top-28">
              <div className="flex items-center justify-between mb-6">
                <h2 className="font-bold text-slate-900" style={{fontFamily:'Manrope,sans-serif'}}>Filters</h2>
          ...
          <main className="flex-1 min-w-0">
            ...
            {loading ? (
              ...
              <div className="text-center py-20 bg-white rounded-2xl border border-slate-100">
                ...
                <h3 className="text-xl font-bold text-slate-700 mb-2" style={{fontFamily:'Manrope,sans-serif'}}>No products found</h3>
