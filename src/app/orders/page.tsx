      ...
      <div className="container mx-auto px-4 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center justify-between mb-8">
            <h1 className="text-4xl font-extrabold text-slate-900" style={{fontFamily:'Manrope,sans-serif'}}>My Orders</h1>
          ...
          {orders.length === 0 ? (
            <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-16 text-center">
              ...
              <h3 className="text-xl font-bold mb-2" style={{fontFamily:'Manrope,sans-serif'}}>No orders yet</h3>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <p className="font-extrabold text-slate-900 text-lg" style={{fontFamily:'Manrope,sans-serif'}}>₹{order.total.toLocaleString('en-IN')}</p>
