      ...
      <section className="bg-gradient-to-br from-primary-950 to-primary-900 py-16 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-5xl font-extrabold text-white mb-4" style={{fontFamily:'Manrope,sans-serif'}}>Contact Us</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="space-y-5">
              <h2 className="text-2xl font-extrabold text-slate-900" style={{fontFamily:'Manrope,sans-serif'}}>How to Reach Us</h2>
              {[
                { icon: Mail, label: 'Email', value: 'info@akyotosecure.com', sub: 'We respond within 24 hours', href: 'mailto:info@akyotosecure.com' },
                { icon: Phone, label: 'Phone', value: '+91-9650715739, 9650409811', sub: 'Service 24/7 available', href: 'tel:+919650715739' },
                { icon: MapPin, label: 'Address', value: 'C-2nd/125, Raju Park, Devli Road, Khanpur, New Delhi-110080', sub: 'M/s Reyansh Enterprises', href: 'https://maps.google.com/maps?q=C-2nd%2F125%2C%20Raju%20Park%2C%20Devli%20Road%2C%20Khanpur%20New%20Delhi-110080' },
              ...
              <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-6 text-white">
                <h3 className="font-bold mb-4" style={{fontFamily:'Manrope,sans-serif'}}>Quick Services</h3>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="lg:col-span-2">
              <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-slate-100 p-8">
                <h2 className="text-2xl font-extrabold text-slate-900 mb-6" style={{fontFamily:'Manrope,sans-serif'}}>Send a Message</h2>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-extrabold text-slate-900" style={{fontFamily:'Manrope,sans-serif'}}>Find Us</h2>
                <p className="text-slate-500 text-sm">C-2nd/125, Raju Park, Devli Road, Khanpur, New Delhi-110080</p>
              </div>
            </div>
            <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm w-full" style={{ height: '450px' }}>
              <iframe
                src="https://maps.google.com/maps?q=C-2nd%2F125%2C%20Raju%20Park%2C%20Devli%20Road%2C%20Khanpur%20New%20Delhi-110080&t=m&z=15&output=embed&iwloc=near"
                width="100%"
                height="100%"
