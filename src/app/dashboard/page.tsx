      ...
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-4xl font-extrabold text-slate-900" style={{fontFamily:'Manrope,sans-serif'}}>My Dashboard</h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              ...
              <div key={i} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5">
                ...
                <p className="text-3xl font-extrabold text-slate-900 mb-0.5" style={{fontFamily:'Manrope,sans-serif'}}>{stat.value}</p>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm">
                <div className="p-6 border-b border-slate-100 flex items-center justify-between">
                  <h2 className="font-bold text-lg text-slate-900" style={{fontFamily:'Manrope,sans-serif'}}>Recent Orders</h2>
            ...
            <div className="space-y-5">
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
                <div className="flex items-center gap-3 mb-5">
                  <div className="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-700 rounded-xl flex items-center justify-center text-white font-bold text-lg" style={{fontFamily:'Manrope,sans-serif'}}>
              ...
              <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-2xl p-6 text-white">
                ...
                <h3 className="font-bold mb-2" style={{fontFamily:'Manrope,sans-serif'}}>Need Help?</h3>
