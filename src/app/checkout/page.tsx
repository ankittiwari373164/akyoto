    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-4xl font-extrabold text-slate-900 mb-8" style={{fontFamily:'Manrope,sans-serif'}}>Checkout</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 mb-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl font-bold" style={{fontFamily:'Manrope,sans-serif'}}>Shipping Information</h2>
                  </div>
                ...
                <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 mb-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-xl font-bold" style={{fontFamily:'Manrope,sans-serif'}}>Payment Method</h2>
                  </div>
            ...
            <div>
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 sticky top-28">
                <h2 className="text-lg font-bold mb-5" style={{fontFamily:'Manrope,sans-serif'}}>Order Summary</h2>
                ...
                <div className="border-t border-slate-100 pt-4 space-y-2">
                  ...
                  <div className="flex justify-between font-bold text-lg border-t border-slate-100 pt-2 mt-1">
                    <span>Total</span>
                    <span className="text-primary-700" style={{fontFamily:'Manrope,sans-serif'}}>₹{getTotalPrice().toLocaleString('en-IN')}</span>
                  </div>
                </div>
