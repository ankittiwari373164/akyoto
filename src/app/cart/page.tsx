    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold mb-3" style={{fontFamily:'Manrope,sans-serif'}}>Your cart is empty</h2>
    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-4xl font-extrabold text-slate-900 mb-8" style={{fontFamily:'Manrope,sans-serif'}}>Shopping Cart</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between gap-3 mb-1">
                          <div>
                            ...
                            <Link href={`/product/${item.product.slug}`}>
                              <h3 className="font-bold text-slate-900 hover:text-primary-700 transition-colors leading-snug" style={{fontFamily:'Manrope,sans-serif'}}>
                                {item.product.name}
                              </h3>
                            </Link>
                        ...
                        <div className="flex items-center justify-between mt-4">
                          ...
                          <div className="text-right">
                            <p className="text-xl font-extrabold text-primary-700" style={{fontFamily:'Manrope,sans-serif'}}>
            ...
            <div>
              <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 sticky top-28">
                <h2 className="text-xl font-bold text-slate-900 mb-6" style={{fontFamily:'Manrope,sans-serif'}}>Order Summary</h2>
                <div className="space-y-3 mb-6">
                  ...
                  <div className="border-t border-slate-100 pt-3 flex justify-between">
                    ...
                    <span className="text-2xl font-extrabold text-primary-700" style={{fontFamily:'Manrope,sans-serif'}}>₹{getTotalPrice().toLocaleString('en-IN')}</span>
                  </div>
                </div>
