      ...
      <section className="bg-gradient-to-br from-primary-950 to-primary-900 py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-5xl font-extrabold text-white mb-5" style={{fontFamily:'Manrope,sans-serif'}}>
              About Akyoto Secure
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <h2 className="text-4xl font-extrabold mt-2 mb-6 leading-tight" style={{fontFamily:'Manrope,sans-serif'}}>
            ...
            <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-3xl p-10 text-white relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <h3 className="text-2xl font-bold mb-4" style={{fontFamily:'Manrope,sans-serif'}}>Our Mission</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-slate-900 mb-2" style={{fontFamily:'Manrope,sans-serif'}}>{v.title}</h3>
                    ...
                    <div className="flex-1 flex justify-end">
                      {isLeft ? (
                        <div className="bg-white rounded-xl p-4 border border-slate-100 shadow-sm w-full">
                          <p className="text-sm font-bold text-primary-700 mb-1" style={{fontFamily:'Manrope,sans-serif'}}>{m.year}</p>
