        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <span className="text-xl font-extrabold tracking-tight" style={{fontFamily:'Manrope,sans-serif'}}>AKYOTO</span>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-bold text-base mb-5 text-white" style={{fontFamily:'Manrope,sans-serif'}}>Quick Links</h3>
          ...
          {/* Products */}
          <div>
            <h3 className="font-bold text-base mb-5 text-white" style={{fontFamily:'Manrope,sans-serif'}}>Categories</h3>
            <ul className="space-y-3">
              {[
                'CCTV / Cameras',
                'Smart Locks',
          ...
          {/* Contact */}
          <div>
            <h3 className="font-bold text-base mb-5 text-white" style={{fontFamily:'Manrope,sans-serif'}}>Contact</h3>
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+919650715739" className="text-slate-400 hover:text-primary-400 text-sm transition-colors">+91-9650715739, 9650409811</a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin size={16} className="text-primary-400 mt-0.5 flex-shrink-0" />
                <span className="text-slate-400 text-sm">
                  M/s Reyansh Enterprises<br />
                  C-2nd/125, Raju Park, Devli Road<br />
